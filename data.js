...
ChapterCards = [
    ...
    {//32
        Text: [
            ...
            `<p><b><i>Сражение началось...</i></b></p>`,
            `<p>Особенности боя: вместо того, чтобы убрать кубик главы при попадании по этому врагу, бросьте его. Если выпал разум, не убирайте его, а положите стороной с разумом вверх.</p>`
        ],
        Actions: [
            {
                Dice: ["cunning","wisdom","character"],
